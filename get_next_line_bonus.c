...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/19 17:14:17 by rakpinar          #+#    #+#             */
/*   Updated: 2023/02/20 18:45:16 by rakpinar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_get_read(int fd, char *buffer)
{
	...
	now_buffer = (char *)malloc(sizeof(char) * BUFFER_SIZE + 1);
	if (!now_buffer)
		return (0);
	rd_byte = 1;
...
char	*get_next_line(int fd)
{
	...
	if (fd == -1 || BUFFER_SIZE <= 0)
		return (0);
	buffer[fd] = ft_get_read(fd, buffer[fd]);
	if (!buffer[fd])
		return (0);
